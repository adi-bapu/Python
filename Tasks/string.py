...
# print(f"Count of '0' in sentence : {sentence.count('o')}")
...
# print(f"Does the string start with 'Python'? {text.startswith('Python')}")
# print(f"Does the string start with 'java'? {text.startswith('java')}")
#    Output: 
...
# print(f"Index of 'how' in text : {text.find('how')}")
...
# text = "I like ice cream and ice cream likes me."
# print(f"{text.replace('ice cream','gelato')}")
...
#    Input: text = "Hello123"
text = "Hello123"
print(f"Is 'Hello123 alphanumeric ? {text.isalnum()}")
